...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="container">
      <form class="form-input" action="test1.php" method="post">
        ...
        <div id="parent" class="form-input">
          <div id="block_1" class="parent_div">
            <div class="child_div">
              <input type="text" class="form-control" placeholder="A,B,C" autofocus name="left_input_1">
            </div>
            <img class="img_container" src="arrow.jpg" alt="dependency">
            <div class="child_div">
              <input type="text" class="form-control" placeholder="D,E,F" autofocus name="right_input_1">
            </div>
